    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        body::before {
            ...
            position: fixed;
            inset: 0;
            background-image: radial-gradient(circle, #e53e3e18 1px, transparent 1px);
        ...
        .card {
            ...
            width: 100%;
            text-align: center;
            box-shadow: 0 4px 32px rgba(229,62,62,.10);
        }
...
<div class="card" role="main" aria-labelledby="title">
    ...
    <p>Qualcosa è andato storto sul nostro server.<br>Il problema è stato registrato e verrà risolto al più presto.</p>
