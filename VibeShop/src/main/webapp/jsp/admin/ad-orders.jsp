...
<main class="admin-main-container">
    <header class="admin-hero">
        <div class="admin-welcome-box"><div class="admin-icon admin-icon-logo"><img src="${pageContext.request.contextPath}/img/logo.svg" alt="VibeShop" /></div><div class="admin-welcome-text"><h1>Gestione Ordini</h1><p>Ordini letti dal database MySQL.</p></div></div>
        <div class="admin-quick-stats"><div class="quick-stat"><span class="stat-val"><%= orders.size() %></span><span class="stat-lbl">Ordini</span></div></div>
    </header>
    <div class="admin-content-grid">
        <aside class="admin-sidebar"><nav class="sidebar-nav"><a href="${pageContext.request.contextPath}/admin/dashboard">Panoramica</a><a href="${pageContext.request.contextPath}/admin/orders" class="active">Gestione Ordini</a><a href="${pageContext.request.contextPath}/admin/products">Gestione Prodotti</a><a href="${pageContext.request.contextPath}/admin/artists">Gestione Artisti</a><a href="${pageContext.request.contextPath}/admin/concerts">Gestione Concerti</a><a href="${pageContext.request.contextPath}/logout" class="logout-link">Disconnetti</a></nav></aside>
        <div class="admin-main-view"><section class="card-vibe"><div class="section-title-row"><h2>Registro Ordini Ricevuti</h2></div>
            <form class="admin-filters-bar" method="get" action="${pageContext.request.contextPath}/admin/orders"><div class="filter-group-select"><label for="idUtente">ID Cliente</label><input type="number" id="idUtente" name="idUtente" placeholder="Es. 1" /></div><div class="filter-group-select"><label for="from">Da</label><input type="date" id="from" name="from" /></div><div class="filter-group-select"><label for="to">A</label><input type="date" id="to" name="to" /></div><button type="submit" class="btn-table-edit">Filtra</button></form>
            <div class="table-responsive"><table class="admin-table"><thead><tr><th>Codice Ordine</th><th>ID Cliente</th><th>Data</th><th>Totale</th><th>Pagamento</th><th>Stato</th><th>Azioni</th></tr></thead><tbody>
                <% if (orders.isEmpty()) { %>
